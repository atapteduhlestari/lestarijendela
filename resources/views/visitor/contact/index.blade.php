				...
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					...
					<form action="/home/feedback" method="POST" id="formAdd">
						...
						<div class="bor8 m-b-30">
							<textarea class="stext-111 cl2 plh3 size-120 p-lr-28 p-tb-25 form-control @error('description') is-invalid @enderror" name="description" placeholder="How Can We Help?"></textarea>
						</div>
