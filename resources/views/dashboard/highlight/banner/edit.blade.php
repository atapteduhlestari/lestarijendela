    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h6 class="m-0 font-weight-bold text-center">Update Banner</h6>
            </div>
            <div class="card-body">
                <form action="/hightlight-banner/{{ $banner->id }}" method="POST" id="formAdd"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="card" style="width: 18rem;">
                                <img src="{{ '/uploads/' . $banner->url }}" alt="">
                            </div>
                        </div>
                    </div>
