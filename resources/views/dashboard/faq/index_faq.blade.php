                            ...
                            <h4 class="panel-title">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <a role="button" class="btn btn-link text-dark" data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $row_count; ?>" aria-expanded="false""> {{$row_count}} . {{$faqs[$x]['question']}} </a>
                                       
                                        <div class="d-flex justify-content">

                                            <a href="/faq/{{$faqs[$x]['id']}}/edit" class="btn btn-outline-dark text-xs">Edit</a>
                                                <form action="/faq/{{$faqs[$x]['id']}}" method="post" class="d-inline" id="deleteForm">
                                                    @csrf
                                                    @method('delete')
