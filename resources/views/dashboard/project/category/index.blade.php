...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Project Category</h1>
        <div class="my-4">
            <div class="d-flex">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-around">
                                            <div>
                                                <a title="Edit Data" href="/project-category/{{ $category->id }}/edit"
                                                    class="btn btn-outline-dark btn-sm">Edit</a>
                                            </div>
                                            <div>
                                                <form action="/project-category/{{ $category->id }}" method="post"
                                                    id="deleteForm">
                                                    @csrf
                                                    @method('delete')
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/project-category" method="post" id="formAdd">
                        @csrf
...
@push('scripts')
    ...
    <script>
        ...
        $(document).on('click', '#deleteButton', function(e) {
            e.preventDefault();
            let id = $(this).data('id');
            formDelete.attr('action', `/project-category/${id}`)
            Swal.fire({
                title: 'Are you sure?',
